...
Public Class PrintForm
        ...
        Try
            ...
            If (dt.Rows.Count > 0) Then
                ...
                If dt.Rows(0).Item("cr_id") = 0 Then
                    row.findings = dt.Rows(0).Item("specify")
                Else
                    row.findings = dt.Rows(0).Item("crime_offense")
                End If
    ...
    End Sub
    'Private Function Qrcode(qrString As String) As Bitmap
    '    Dim gen As New QRCodeGenerator
    '    Dim data = gen.CreateQrCode(qrString, QRCodeGenerator.ECCLevel.Q)
    '    Dim code As New QRCode(data)
    '    Return code.GetGraphic(150)
    'End Function
End Class